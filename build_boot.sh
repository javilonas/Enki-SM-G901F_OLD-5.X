#!/bin/bash
#
# Build Script: Javilonas, 24-04-2015
...
make ARCH=arm CROSS_COMPILE=$TOOLCHAIN -C $(pwd) O=output lonas_defconfig KCONFIG_VARIANT= KCONFIG_DEBUG= KCONFIG_TIMA= KCONFIG_DMVERITY= KCONFIG_LOG_SELINUX= KCONFIG_SELINUX=
